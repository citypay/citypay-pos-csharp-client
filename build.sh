...
${nuget_cmd} install src/CityPay.Pos/packages.config -o packages;
...
echo "[INFO] Run 'mcs' to build bin/CityPay.Pos.dll"
mcs -langversion:${langversion} -sdk:${sdk} -r:bin/Newtonsoft.Json.dll,\
bin/RestSharp.dll,\
System.ComponentModel.DataAnnotations.dll,\
System.Runtime.Serialization.dll \
-target:library \
-out:bin/CityPay.Pos.dll \
-recurse:'src/CityPay.Pos/*.cs' \
-doc:bin/CityPay.Pos.xml \
-platform:anycpu
...
then
  ...
  echo "[INFO] bin/CityPay.Pos.dll was created successfully"
fi
