...
namespace CityPay.Pos.Model
{
    ...
    public partial class Receipt :  IEquatable<Receipt>, IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="Customer">The customer receipt to be printed or stored.</param>
        public Receipt(string Customer = default(string))
        {
        ...
        /// </summary>
        /// <value>The customer receipt to be printed or stored</value>
